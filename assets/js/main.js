(function ($) {
	...
	=============================================*/
    function makeTimer() { 
		var endTime = new Date("27 jun 2026 17:00:00");      
	...
	/*=============================================
		=   slide-poster-in-events-details   =
	=============================================*/
		
	var slider = new Swiper('.td-schedule-details-active', {
		slidesPerView: 1,
		spaceBetween: 0,
		loop: true,
		autoplay: {
		...
		navigation: {
			nextEl: ".td-schedule-details-next",
			prevEl: ".td-schedule-details-prev",
		},
	});
